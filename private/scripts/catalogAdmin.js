...
function redirectToCardEdit(article) {
    console.log(article);
    
    window.location=`http://localhost:3000/admin/adminCatalog/productEdit?article=${article}`
}
...
brandListItems.forEach((item,index)=> {
    item.addEventListener('click', () => {
        ...
        if(url=="http://localhost:3000/admin/adminCatalog"){
            url="http://localhost:3000/admin/adminCatalog?sex=&type=&brand=&title="
        }
        console.log(url);
